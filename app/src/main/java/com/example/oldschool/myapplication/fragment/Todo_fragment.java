...
public class Todo_fragment extends AbstracktTabFragment {
    ...
    public static FragmentExample getInstance(Context context) {
        ...
        fragment.setTitle(context.getString(R.string.atab_item_TODO));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_todo_fragment, container, false);
